...
const Footer = () => {
  return (
    <div
      className="text-[#d9d9d9] bg-[#323232] flex flex-col items-center gap-5 pt-15 md:pt-20 px-[8vw] py-5 mt-24"
      id="contact"
    >
      <div className="w-full grid grid-cols-[2fr_1fr_1fr] gap-20 footer-content max-[750px]:flex max-[750px]:flex-col max-[750px]:gap-[35px]">
        ...
        <div className="flex flex-col items-start gap-5">
          ...
          <ul className="flex flex-col gap-2 list-none">
            <li className="cursor-pointer hover:text-white transition-colors font-medium ">
              Home
            </li>
            <li className="cursor-pointer hover:text-white transition-colors font-medium ">
              About Us
        ...
        <div className="flex flex-col items-start gap-5">
          ...
          <ul className="flex flex-col gap-2 list-none">
            ...
            <li className="cursor-pointer hover:text-white transition-colors font-medium ">
              arikan950@hotmail.com
            </li>
          </ul>
        </div>
      </div>
      <hr className="w-full h-0.5 my-5 border-none bg-gray-300 " />
      <p className="text-center font-medium footer-copyright">
